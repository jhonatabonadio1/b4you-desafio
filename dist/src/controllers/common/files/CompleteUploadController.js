...
exports.CompleteUploadController = void 0;
const CompleteUploadService_1 = require("../../../services/common/files/CompleteUploadService");
class CompleteUploadController {
    ...
    async handle(req, res) {
        try {
            ...
            const completeUploadService = new CompleteUploadService_1.CompleteUploadService();
...
exports.CompleteUploadController = CompleteUploadController;
