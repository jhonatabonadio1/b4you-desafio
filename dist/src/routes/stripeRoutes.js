...
const verifyCheckoutSessionExistsController = new VerifyCheckoutSessionExistsController();
stripeRoutes.post('/stripe/create-checkout', ensureAuthenticated, userInBlacklist, createCheckoutSessionController.handle);
stripeRoutes.get('/stripe/session/:sessionId', ensureAuthenticated, userInBlacklist, verifyCheckoutSessionExistsController.handle);
stripeRoutes.get('/stripe/portal', ensureAuthenticated, userInBlacklist, createPortalSessionController.handle);
export { stripeRoutes };
