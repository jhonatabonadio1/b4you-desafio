...
trackingRoutes.get('/tracking/:docId', ensureAuthenticated, userInBlacklist, fetchDocumentTrackingController.handle);
trackingRoutes.get('/tracking/:docId/pages', ensureAuthenticated, userInBlacklist, fetchPageAnalyticsController.handle);
