...
userRoutes.put('/users', ensureAuthenticated, userInBlacklist, updateUserController.handle);
userRoutes.put('/users/update-password', userInBlacklist, updateUserPasswordController.handle);
export { userRoutes };
