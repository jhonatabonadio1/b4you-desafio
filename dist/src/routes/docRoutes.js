...
docRoutes.post('/file', ensureIsAuthenticated_1.ensureAuthenticated, userInBlacklist_1.userInBlacklist, 
// @ts-ignore
upload_1.upload.single('file'), uploadFileController.handle);
